            ...
            <div>
                <ul class="mt-6 leading-10">
                    ...
                    <x-sidebar.dropdown-nav-item active="open" title="MAINTENANCE" uri="maintenance/*">
                        ...
                        <x-sidebar.dropdown-nav-item active="open" title="REFERENCE" uri="reference/*">
                            <x-slot name="icon">
                                <x-heroicon-o-document-search class="w-7 h-7" />
                            </x-slot>
                            <div class="leading-5">
                                ...
                                <x-sidebar.nav-item title="COUNTRY"  route="{{ route('country') }}" uri="country">
                                ...
                                <x-sidebar.nav-item title="RELIGION"  route="{{ route('religion') }}" uri="religion">
                                ...
                                <x-sidebar.nav-item title="STATE"  route="{{ route('state') }}" uri="state">
                                ...
                                <x-sidebar.nav-item title="GENDER"  route="{{ route('gender') }}" uri="gender">
