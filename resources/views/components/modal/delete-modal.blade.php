...
<div
    ...
    >
	<div
        class="w-full mb-5 transition-all transform sm:mt-20 sm:mb-20 sm:max-w-lg"
		...
		<div {{ $attributes->merge(['class' => '']) }}>
            <div class="relative w-full h-full max-w-md p-4 md:h-auto">
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    <button @click="{{ $modalActive }} = false" type="button" class="absolute top-3 right-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center dark:hover:bg-gray-800 dark:hover:text-white" data-modal-toggle="popup-modal">
