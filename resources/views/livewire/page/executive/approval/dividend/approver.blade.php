<div class="p-4">
    <h1 class="text-base font-semibold md:text-2xl">Dividend Application (APPROVER)</h1>
    <x-general.card class="p-4 mt-4 bg-white rounded-md shadow-md">
        ...
        <div class="grid grid-cols-12 gap-6">
            ...
            <div class="col-span-4 sm:col-span-4 md:col-span-2 lg:col-span-2 xl:col-span-2">
                <x-form.input-tag
                    ...
                    id="Apply.div_share_apply"
                    name="Apply.div_share_apply"
                    value="{{ $Apply->div_share_approved }}"
                    leftTag="RM"
                    rightTag=""
                    mandatory=""
                    disable="true"
            ...
            <div class="col-span-4 sm:col-span-4 md:col-span-2 lg:col-span-2 xl:col-span-2">
                <x-form.input-tag
                    ...
                    id="Apply.div_contri_apply"
                    name="Apply.div_contri_apply"
                    value="{{ $Apply->div_contri_approved }}"
                    leftTag="RM"
                    rightTag=""
                    mandatory=""
                    disable="true"
        ...
        <div class="p-4 mt-6 rounded-md bg-gray-50 dark:bg-gray-600">
            <div class="flex items-center justify-center space-x-2">
                <button wire:click="next('gagal')" type="button" class="flex items-center justify-center p-2 text-sm font-semibold text-white bg-red-500 rounded-md focus:outline-none">
                    VOTE REFUSE
                </button>
                <button wire:click="deb" type="button" class="flex items-center justify-center p-2 text-sm font-semibold text-white bg-green-500 rounded-md focus:outline-none">
                    debug
                </button>
