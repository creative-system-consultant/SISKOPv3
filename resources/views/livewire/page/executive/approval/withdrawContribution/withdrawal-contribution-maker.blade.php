        ...
        <div class="pb-4 pl-4 pr-4">
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4">
                ...
                <x-form.input-tag
                    ...
                    type="text"
                    name="monthly_cont"
                    value="{{ $maker->customer->contribution_monthly ?? '' }}"
                    leftTag="RM"
                    rightTag=""
                    mandatory=""
                    disable="true"
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3">
                <div>
                    @if ( $maker->files != NULL)
                        @forelse ($maker->files as $supportDoc)
                            <a
                                target="_blank"
                                class="inline-flex items-center px-4 py-2 text-sm font-bold text-white bg-blue-500 rounded-md hover:bg-blue-400"
                                href="{{ asset('storage/'.$supportDoc->filepath) }}"
                            >
