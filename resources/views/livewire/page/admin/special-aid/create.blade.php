<div class="p-4">
    <h1 class="text-base font-semibold md:text-2xl">Special Aid List > {{ $page }}</h1>
        <x-general.card class="p-4 mt-4 bg-white rounded-md shadow-md">
            <x-general.header-title title="{{ $page }} Special Aid" route="{{route('special_aid.list')}}"/>
            <div class="pt-4">    
                    ...
                    <x-form.basic-form wire:submit.prevent="submit('{{ $specialAid?->uuid }}')">
                        ...
                        @foreach($Fname as $index => $list )
                            <div class="grid grid-cols-12 gap-6 mt-6">
                                ...
                                <div class="col-span-12 sm:col-span-12 md:col-span-4 lg:col-span-1 xl:col-span-1">
                                    <label for="field_status" class="block mr-3 text-sm font-semibold leading-5 text-gray-700">
                                        Enable
                                    </label>
                                ...
                                <div class="col-span-12 sm:col-span-12 md:col-span-4 lg:col-span-1 xl:col-span-1">
                                    <div class="justify-end pt-4 mt-3 rounded-md">
                        ...
                        <div class="p-4 mt-6 rounded-md bg-gray-50 dark:bg-gray-600">
                            <div class="flex items-center justify-center space-x-2">
                                <a href="{{route('special_aid.list')}}" class="flex items-center justify-center p-2 text-sm font-semibold text-gray-500 bg-white border-2 rounded-md focus:outline-none">
                                    Cancel
                                </a>
