<div class="p-4">
    ...
    <x-general.card class=" mt-4 py-4  rounded-md shadow-md relative"  x-data="{ active:0 }" @increment-tab.window="active++" @decrement-tab.window="if(active > 0) active--">
        <div class="flex flex-wrap justify-start sm:justify-start bg-white dark:bg-gray-800 shadow-lg rounded-lg mx-4 px-4">
            <x-hovertab.title name="0" varble="{{$tab1}}" wire:click="next(1,1)">
                <x-heroicon-o-user-circle class="w-6 h-6 " />
                <span class="text-sm tooltip-text bg-primary-400 border rounded border-primary-500 text-white -mt-14">
                    Personal Detail
                </span>
            </x-hovertab.title>
            <x-hovertab.title name="1" varble="{{$tab2}}" wire:click="next(2,1)">
                <x-heroicon-o-home class="w-6 h-6 " />
                <span class="text-sm tooltip-text bg-primary-400 border rounded border-primary-500 text-white -mt-14">
                    Addresses
                </span>
            </x-hovertab.title>
            <x-hovertab.title name="2" varble="{{$tab3}}" wire:click="next(3,1)">
                <x-heroicon-o-user-group class="w-6 h-6 " />
                <span class="text-sm tooltip-text bg-primary-400 border rounded border-primary-500 text-white -mt-14">
                    Beneficiary
                </span>
            </x-hovertab.title>
            <x-hovertab.title name="3" varble="{{$tab4}}" wire:click="next(4,1)">
                <x-heroicon-o-briefcase class="w-6 h-6 " />
                <span class="text-sm tooltip-text bg-primary-500 border rounded border-primary-500 text-white -mt-14">
                    Employment
                </span>
            </x-hovertab.title>
            <x-hovertab.title name="4" varble="{{$tab5}}" wire:click="next(5,1)">
                <x-heroicon-o-building-office class="w-6 h-6 " />
                <span class="text-sm tooltip-text bg-primary-500 border rounded border-primary-500 text-white -mt-14">
                    Introducer
                </span>
            </x-hovertab.title>
            <x-hovertab.title name="5" varble="{{$tab6}}" wire:click="next(6,1)">
                <x-heroicon-o-credit-card class="w-6 h-6 " />
                <span class="text-sm tooltip-text bg-primary-500 border rounded border-primary-500 text-white -mt-14">
                    Deduction & Payment
                </span>
            </x-hovertab.title>
            <x-hovertab.title name="6" varble="{{$tab7}}" wire:click="next(7,1)">
                <x-heroicon-o-arrow-up-tray class="w-6 h-6 " />
                <span class="text-sm tooltip-text bg-primary-500 border rounded border-primary-500 text-white -mt-14">
                    Upload Document
                </span>
            </x-hovertab.title>
            <x-hovertab.title name="7" varble="{{$tab8}}" wire:click="next(8,1)">
