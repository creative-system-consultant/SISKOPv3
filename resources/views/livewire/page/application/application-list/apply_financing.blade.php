        ...
        <div class="pb-4 pl-4 pr-4">
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4">
                <x-form.input
                    label="Name"
                    name=""
                    value="{{ $custApply->customers->name ?? '' }}"
                    mandatory=""
                    disable="true"
                    type="text"
                />
                <x-form.input
                    ...
                    name=""
                    value="{{ $custApply->customers->icno ?? '' }}"
                    mandatory=""
                    disable="true"
                    type="text"
                />
                <x-form.input
                    ...
                    type="date"
                    name=""
                    value="{{ $custApply->customers->birthdate ?? '' }}"
                    mandatory=""
                    disable="true"
                />
                <x-form.input
                    ...
                    type="text"
                    name=""
                    value="{{ $custApply->customers->mobile_num ?? '' }}"
                    mandatory=""
                    disable="true"
                    type="text"
                />
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4">
                ...
                <x-form.input
                    ...
                    type="text"
                    name=""
                    value="{{ $custApply->customers->email ?? '' }}"
                    mandatory=""
                    disable="true"
                    type="text"
                />
                <x-form.input
                    ...
                    type="text"
                    name=""
                    value="{{ $custApply->customers->mbr_no ?? '' }}"
                    mandatory=""
                    disable="true"
                    type="text"
                />
