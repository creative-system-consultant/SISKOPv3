    ...
    <x-slot name="tbody">
        @forelse ($specialAid as $aid)
            <tr>
                ...
                <x-table.table-body colspan="" class="text-left">
                    <a href="{{route('application.specialAid', $aid->uuid)}}" class="inline-flex items-center px-2 py-2 text-sm font-bold text-white bg-green-500 rounded-full hover:bg-green-400" title="Show Application">
