    ...
    <x-slot name="tbody">
        @forelse ($withdrawal as $withdraw)
            <tr>
                ...
                <x-table.table-body colspan="" class="text-left">
                    <a href="{{ route('application.withdrawal', $withdraw->uuid) }}" class="inline-flex items-center px-2 py-2 text-sm font-bold text-white bg-green-500 rounded-full hover:bg-green-400" title="Show Application">
