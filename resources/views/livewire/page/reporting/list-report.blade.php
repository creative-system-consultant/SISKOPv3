    ...
    <div class="overflow-hidden ">
        ...
        <section class="absolute inset-y-0 flex max-w-full md:-ml-[0.5em] ml-0 mt-[4.4em]" aria-labelledby="slide-over-heading">
            <div class="relative w-screen max-w-md">
                <div class="flex flex-col h-full py-6 pt-0 overflow-auto bg-white shadow-xl animate__animated animate__fadeInLeft">
                    ...
                    <div class="relative flex-1 px-4 mt-6 sm:px-6">
                        ...
                        <div class="pb-8 border-2 border-gray-200">
                            <div class="h-full leading-6" aria-hidden="true">
                                <ul id="myUL">
                                    <li>
                                        <a href="{{route('user-reporting')}}" class="inline-flex items-center w-full px-4 py-2 text-sm font-semibold text-gray-500 hover:text-primary-800">
