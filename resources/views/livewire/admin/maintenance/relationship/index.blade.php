<div class="p-4">
    <h1 class="text-base font-semibold md:text-2xl">Relationship List</h1>
            ...
            <x-slot name="tbody">
                ...
                <tr>
                    ...
                    <x-table.table-body colspan="1" class="text-left"  x-data="{deleteModal:false}">
                        <a href="{{ route('relationship.edit',$item->id) }}" class="inline-flex items-center px-4 py-2 text-sm font-bold text-white bg-orange-500 rounded hover:bg-orange-400">
