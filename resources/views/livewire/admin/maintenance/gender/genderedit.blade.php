<div class="p-4">
    <h1 class="text-base font-semibold md:text-2xl">Gender Maintenance > Edit</h1>
    <x-general.card class="p-4 mt-4 bg-white rounded-md shadow-md">
        <x-general.header-title title="Gender Edit Information" route="{{ route('gender.list') }}"/>
        <x-form.basic-form wire:submit.prevent="submit('{{ $RefGender->id }}')" class="p-4">
