<div class="p-4">
    <h1 class="text-base font-semibold md:text-2xl">Gender Maintenance</h1>
                ...
                @forelse ($RefGender as $gender)
                    <tr>
                        ...
                        <x-table.table-body colspan="" class="text-left" x-data="{deleteModal:false}">
                            ...
                            <x-modal.delete-modal modalActive="deleteModal" deleteFunction="delete({{ $gender->id }})" />
                        </x-table.table-body>
                    </tr>
                @empty
                    <tr>
