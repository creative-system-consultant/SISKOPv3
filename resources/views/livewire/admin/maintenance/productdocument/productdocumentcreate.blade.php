<div class="p-4">
    <h1 class="text-base font-semibold md:text-2xl">Product Document Maintenance > Create</h1>
    <x-general.card class="p-4 mt-4 bg-white rounded-md shadow-md">
        <x-general.header-title title="Product Document Create Information" route="{{ route('productdocument.list') }}"/>
