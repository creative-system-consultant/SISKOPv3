<div class="p-4">
    <h1 class="text-base font-semibold md:text-2xl">Country Maintenance > Create</h1>
        <div class="p-4 mt-4 bg-white rounded-md shadow-md">
            <x-general.header-title title="Country Create Information" route="{{route('country.list')}}"/>
