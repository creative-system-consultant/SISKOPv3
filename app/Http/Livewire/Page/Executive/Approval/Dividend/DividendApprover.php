...
class DividendApprover extends Component
{
    ...
    public function next($vote = 'approve')
    {
        ...
        if ($this->Apply->count_unvote(4) == 0){
            if ($this->Apply->vote_result(4)){
                $this->Apply->flag = 20;

                $mes_ws  = 'SISKOPv3 Application have been Approved by APPROVER';
                $mes_sms = 'RM0 SISKOPv3 Application have been Approved by APPROVER';
                $mes     = 'Application Dividend Payout Approved';
            } else {
                $this->Apply->flag = 23;

                $mes_ws  = 'SISKOPv3 Application have been Rejected by APPROVER';
                $mes_sms = 'RM0 SISKOPv3 Application have been Rejected by APPROVER';
    ...
    {
        return view('livewire.page.executive.approval.dividend.approver')->extends('layouts.head');
    }
}
